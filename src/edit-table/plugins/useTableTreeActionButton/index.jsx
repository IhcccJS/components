...
function useTableTreeActionButton() {
  return { name: 'actionButton', actionColumn, actionButtons };
}

useTableTreeActionButton.before = () => {
  return {
    event: {
      // row event
...
useTableTreeActionButton.initialStore = () => {
  return { data: {}, event: {} };
};

export default useTableTreeActionButton;
