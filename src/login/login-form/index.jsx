  ...
  return (
    <Form layout="vertical" {...restProps}>
      ...
      >
        <Input
          size={size}
          prefix={<UserOutlined className={cx(styles, 'prefixIcon')} />}
          placeholder="请输入"
        />
      </Form.Item>
      <Form.Item
      ...
      >
        <Input.Password
          size={size}
          prefix={<LockOutlined className={cx(styles, 'prefixIcon')} />}
          placeholder="请输入"
        />
      </Form.Item>
  ...
  return (
    <Form layout="vertical" {...restProps}>
      ...
      >
        <Input
          size={size}
          prefix={<MailOutlined className={cx(styles, 'prefixIcon')} />}
          placeholder="请输入"
        />
      </Form.Item>
      <Form.Item
      ...
      >
        <VerifyCode
          size={size}
          prefix={
            <SafetyCertificateOutlined className={cx(styles, 'prefixIcon')} />
          }
          placeholder="请输入"
          timecount={timecount}
          onSend={onSend}
